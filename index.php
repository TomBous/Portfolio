    ...
    ?>
      ...
      <main class="main" role="main">
        ...
        <section id="cover">
          <div class="container">
            <div class="card">
              ...
              <h2> Full Stack</h2>
              <p>Actuellement en formation, je recherche un stage de mi-parcours.</p>
              <a href="#section4">
        ...
        <div id="section1-before">
          <img src="./assets/img/newsunrise.svg" alt="">
        </div>
        <section id="section1">
          <div class="container">
            <h1>LANGAGES</h1>
          ...
          <div class="container">
            <div class="row spacebtw">
              <div id="formations" class="formation">
                ...
                <div>Web développeur -  Full Stack JS - Simplon.co</div>
              </div>
              <div id="xp" class="formation">
                ...
                <div>Tentative de création de Start-Up Bebe-Sitting.fr - Apprentissage de HTML et CSS - Construction de la plateforme de mise en relation entre parents et baby-sitters.</div>
                ...
                <div class="parallelogramme"><span class="date">2018</span></div>
        ...
        <div class="container">
          ...
          <form onsubmit="submitForm(); return false;" class="contact-form" id="register-form">
